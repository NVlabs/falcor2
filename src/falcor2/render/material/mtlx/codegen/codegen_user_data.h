...
struct AnalysisState {
    ...
    /// Per-input property names saved before class compilation canonicalizes Slang bindings.
    std::unordered_map<const MaterialX::ShaderPort*, std::string> pre_canonical_input_names;
};
