...
MxFlatRootDesc
make_mtlx_bsdf_mix_root_desc(const LayeringDesc& desc, const ProfileDesc& profile, const std::string& root_type_name)
{
...
)
{
    shadergen.emitString(
        emit_bsdf_mix_root_bsdf(make_mtlx_bsdf_mix_root_desc(layering, profile, bsdf_mix_root_type)),
        stage
    );
}
