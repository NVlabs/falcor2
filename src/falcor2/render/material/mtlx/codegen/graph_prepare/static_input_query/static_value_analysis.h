...
using RuntimeInputPredicate = std::function<bool(const MaterialX::ShaderOutput&)>;
...
analyze_static_values_to_fixpoint(const MaterialX::ShaderGraph& top, const RuntimeInputPredicate& is_runtime_input);
