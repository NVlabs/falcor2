...
vcpkg_from_github(
    ...
    PATCHES
        ...
        fix-gcc13-changes-meaning.patch
        fix-clang-enum-kind-type.patch
)
...
if (NOT VCPKG_TARGET_IS_WINDOWS)
    ...
    macro(CONFIGURE_PROJ_FILE arg)
        ...
        # --- Gemini suggestion to fix pdb file locking issue ---
        # Basically kill all debug information to avoid generating .pdb files.
        string(REPLACE "<DebugInformationFormat>ProgramDatabase</DebugInformationFormat>"
                    "<DebugInformationFormat>None</DebugInformationFormat>" SLN_CONFIGURE "${SLN_CONFIGURE}")
        string(REPLACE "<GenerateDebugInformation>true</GenerateDebugInformation>"
                    "<GenerateDebugInformation>false</GenerateDebugInformation>" SLN_CONFIGURE "${SLN_CONFIGURE}")
        string(REPLACE "/Zi" "" SLN_CONFIGURE "${SLN_CONFIGURE}")
